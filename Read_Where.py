...
def read_tipo_produto_descricao(descricao):
    read_tipo_produto_query = "SELECT * FROM tipo_produto WHERE descricao = '" + descricao + "'"
    try:
...
def read_produto_descricao(descricao):
    read_produto_query = "SELECT * FROM produto WHERE descricao = '" + descricao + "'"
    try:
...
def read_maquina_descricao(descricao):
    read_maquina_query = "SELECT * FROM maquina WHERE descricao = '" + descricao + "'"
    try:
